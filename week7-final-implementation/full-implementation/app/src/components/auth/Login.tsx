        ...
        <div className="glass-card-strong p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/60">
              Sign in to access the S.H.I.E.L.D system
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-white/20 bg-white/5 text-shield-purple focus:ring-shield-purple"
                />
                <span className="text-sm text-white/60">Remember me</span>
              </label>
              <button
                type="button"
                className="text-sm text-shield-cyan hover:underline"
              >
                Forgot password?
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="py-3 rounded-lg glass-card flex items-center justify-center gap-2 hover:bg-white/10 transition-colors"
            >
